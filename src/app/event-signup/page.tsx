    ...
    const eventD: EventData = {
        ...
        return (
            <main className="flex min-h-screen flex-col">
                <div className="md:p-16 p-2 pt-16 text-black bold">
                    <h1 className="text-6xl font-bold whitespace-nowrap">Event Signup</h1>
                    <h3 className="text-2xl font-bold whitespace-nowrap" style={{ display: "inline" }}>Event Name:</h3>
                    <h3 style={{ display: "inline", color: "red", whiteSpace: "nowrap" }}> [{eventD.eventName}]</h3>
